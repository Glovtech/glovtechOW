          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <FadeInText delay={400}>
                ...
                Using advanced predictive technology to streamline dispute resolution and enhance customer operations.
                </p>
              </FadeInText>
                ...
                <div className="relative bg-gradient-to-br from-green-900 via-green-800 to-green-700 rounded-3xl shadow-2xl overflow-hidden aspect-square max-w-lg mx-auto">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-black/40 backdrop-blur-md rounded-2xl p-4 z-10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-white font-semibold text-sm">Achieve significant business growth.</p>
                        <p className="text-green-200 text-xs">Innovation Bank of Africa</p>
                      </div>
                    </div>
                  </div>
                </div>
