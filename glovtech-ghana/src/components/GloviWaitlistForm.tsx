...
export default function GloviWaitlistPage() {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        setMessage({
          type: 'success',
          text: "🎉 Welcome aboard! You're on the waitlist for Glovi AI."
        })
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-black to-green-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-emerald-200 rounded-full blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-teal-200 rounded-full blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
      ...
      >
        <div className="text-center lg:text-left space-y-6 px-4">
          ...
          <p className="text-lg sm:text-xl text-gray-400 leading-relaxed">
            Be among the first to experience Glovi AI, your intelligent assistant built to supercharge productivity and decision-making for modern teams.
          </p>

          <div className="space-y-4 pt-6">
            {[
              { text: 'Conversational AI for your workflow' },
              { text: 'Smart document & data analysis' },
              { text: 'Automated task management' },
              { text: 'Seamless integrations & APIs' }
            ].map((feature, index) => (
              <div
                key={index}
