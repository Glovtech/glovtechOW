            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              <div className="lg:col-span-1">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-white">lovtech</h2>
                </div>
                <p className="text-gray-400 leading-relaxed mb-6">
                  Empowering African businesses with cutting-edge AI solutions, web services 
                  and automation for digital transformation.
                </p>
                
                {/* Social Links */}
                <div className="flex gap-3">
                  <a
                    href="https://www.facebook.com/share/189APVeFho/?mibextid=wwXIfr"
                    target="_blank"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center transition-all duration-300"
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {['Blog', 'Careers', 'FAQs', 'Partners', 'Help Center'].map((item) => (
                    <li key={item}>
                      <a
                        href="#"
                        className="text-gray-400 hover:text-white hover:translate-x-2 inline-block transition-all duration-300"
          ...
          <FadeIn delay={300}>
            <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-500 text-sm">
                &copy; 2020 Glovtech Ghana. All rights reserved.
              </p>
